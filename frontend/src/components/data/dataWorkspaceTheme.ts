...
export function getWorkspaceColors(theme: Theme) {
  ...
  return {
    ...
    selectedBg: dark ? "rgba(59, 130, 246, 0.18)" : alpha(theme.palette.primary.main, 0.1),
    hoverBg: dark ? "rgba(148, 163, 184, 0.12)" : alpha(theme.palette.primary.main, 0.08),
    ...
    tokenSelectedBg: dark ? "rgba(96, 165, 250, 0.28)" : alpha(theme.palette.primary.main, 0.16),
    tokenRegeneratedBg: dark ? "rgba(59, 130, 246, 0.18)" : alpha(theme.palette.primary.main, 0.1),
  };
}
